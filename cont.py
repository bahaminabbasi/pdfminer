...
# def build_pattern(extraction_elements):
...
box = {'x0': 517, 'y0': 598, 'x1': 563, 'y1': 611, 'page_number': 1,
'content': 'اﻃﻼﻋﺎت\nاﻃﻼﻋﺎت\n', 'font_name': ['IRANSans-Bold'], 
'font_sieze': [13]}

['QECAAA+IRANSans-Bold']
...
results = sorted_matching_section(file_path, box)
print(results)
